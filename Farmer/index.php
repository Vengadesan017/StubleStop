<?php
	...
	try {
		if (isset($_POST['Flogin'])) {
            ...
            $login = $conn->prepare("SELECT * FROM Users WHERE Phone = ?");
            ...
            if ($rowCount>0) {
                $data=$alldata[0];
                // print_r($data);
                // echo(password_verify($password,$data["Password"])."value");
...
<div class="container">
    <div class="row justify-content-center">
      <div class="col-md-4"><br><br><br><br><br>
        <h3 class="text-center mt-5">FARMER</h3><br><br>
        ...
        <?php
          ...
          <button type="submit" name="Flogin" class="btn btn-success w-100">Login</button>
        </form>
